<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="recepcionsalidapabellon.aspx.cs" Inherits="ges.data.presentation.recepcionsalidapabellon" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="./js/recepcioncontenedores/recepcionsalidapabellon.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <form id="formularioAgregar" name="formularioAgregar" method="post" runat="server"> 
      <asp:hiddenfield runat="server" id="idBodega" Value="1"></asp:hiddenfield>
   ...
   <h3 class="display-4"><i class="mdi mdi-chart-histogram"></i> Recepción Salida Pabellon </h3>
    <div class="row">
        <div class="col-md-2">
