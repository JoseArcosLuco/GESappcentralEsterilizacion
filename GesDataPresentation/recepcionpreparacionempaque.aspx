<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="recepcionpreparacionempaque.aspx.cs" Inherits="ges.data.presentation.recepcionpreparacionempaque" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="./js/recepcioncontenedores/recepcionpreparacionempaque.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 class="display-4"><i class="mdi mdi-chart-histogram"></i> Recepción Preparación Empaque </h3>
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <p class='text-info'><asp:Label ID="datosSalida" runat="server" Text="Debe ingresar un codigo de contenedor para ingresar a preparación empaque."></asp:Label> </p>               
        </div>
        <div class="col-md-8">
            Articulos en Preparación Empaque
        </div>
        <div class="col-md-12">
