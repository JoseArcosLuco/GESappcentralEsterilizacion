<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="recepcionarealavado.aspx.cs" Inherits="ges.data.presentation.recepcionarealavado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="./js/recepcioncontenedores/recepcionarealavado.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 class="display-4"><i class="mdi mdi-chart-histogram"></i> Recepción Area Lavado </h3>
