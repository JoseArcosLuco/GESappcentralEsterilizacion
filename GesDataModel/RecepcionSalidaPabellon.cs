...
{
    public class RecepcionSalidaPabellon
    {
    ...
    public partial class listaRecepcionSalidaPabellon
    {
        public BindingList<RecepcionSalidaPabellon> List = new BindingList<RecepcionSalidaPabellon>();
        public listaRecepcionSalidaPabellon()
        {
        }
        public void Add(RecepcionSalidaPabellon value)
        {
            this.List.Add(value);
        }
    }
